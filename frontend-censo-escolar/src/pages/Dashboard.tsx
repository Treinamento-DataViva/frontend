    ...
    <div className="dashboard-container">
      ...
      <aside className="dashboard-sidebar">
        <div className="p-6 space-y-8">
          ...
          {/* Busca */}
          <div>
            <label className="filter-label mb-2">Buscar & Filtrar</label>
          ...
          {/* Região */}
          <div>
            <label className="filter-label mb-2">Região</label>
          ...
          <div>
            <label className="filter-label mb-3">Tipo de Escola</label>
          ...
          <div>
            <label className="filter-label mb-3">Tags de Infraestrutura</label>
            <div className="flex flex-wrap gap-2">
              <button className="tag-active">Internet</button>
              <button className="tag-inactive">Computer Lab</button>
              <button className="tag-inactive">Library</button>
              <button className="tag-active">Potable Water</button>
              <button className="tag-inactive">Sports Court</button>
            </div>
          </div>
        ...
        <div className="dashboard-content">
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              <button className="btn-header-dark">Map View</button>
              <button className="btn-header-outline">Comparação</button>
              <button className="btn-header-outline flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {[
              ...
              },
              {
                ...
                value: '54.8%',
                icon: 'M4 6a2 2 0 012-2h12a2 2 0 012 2v12a2 2 0 01-2 2H6a2 2 0 01-2-2V6z M4 12h16 M12 4v16',
                      ...
                      <div className="p-2 min-w-50">
                        ...
                        <div className="space-y-1 text-sm text-slate-600">
                          ...
                          <div className="mt-2 pt-2 border-t border-slate-200">
                            <span className={`inline-block px-2 py-1 rounded text-xs font-bold ${escola.qualidade === 'alta' ? 'bg-teal-100 text-teal-700' :
